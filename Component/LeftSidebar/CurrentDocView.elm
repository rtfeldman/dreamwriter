...
view navigateToTitle navigateToChapterId currentDoc =
    div [ key "current-doc-view", id "current-doc-view" ] [ div [ id "title", onClick navigateToTitle () ] [ text currentDoc.title ], viewOutline navigateToChapterId currentDoc.chapters ]
...
viewChapter navigateToChapterId index chapter =
    li [ key ("chapter" ++ (toString index)), title chapter.heading, onClick navigateToChapterId chapter.id ] [ text chapter.heading ]
